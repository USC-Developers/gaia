...
type Params struct {
	...
	// usc_ibc_denoms defines a set of USC denoms that are supported by the redeem operation in addition
	// to the native token ("uusc"). Those denoms are derivatives of the native token from an IBC transfers
	// (A->B->C->A transfers).
	UscIbcDenoms []string `protobuf:"bytes,4,rep,name=usc_ibc_denoms,json=uscIbcDenoms,proto3" json:"usc_ibc_denoms,omitempty" yaml:"usc_ibc_denoms"`
}
...
var fileDescriptor_8575b09df2fdc43e = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if len(this.UscIbcDenoms) != len(that1.UscIbcDenoms) {
		return false
	}
	for i := range this.UscIbcDenoms {
		if this.UscIbcDenoms[i] != that1.UscIbcDenoms[i] {
			return false
		}
	}
	return true
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.UscIbcDenoms) > 0 {
		for iNdEx := len(m.UscIbcDenoms) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.UscIbcDenoms[iNdEx])
			copy(dAtA[i:], m.UscIbcDenoms[iNdEx])
			i = encodeVarintUsc(dAtA, i, uint64(len(m.UscIbcDenoms[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UscIbcDenoms", wireType)
			}
			...
			m.UscIbcDenoms = append(m.UscIbcDenoms, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
