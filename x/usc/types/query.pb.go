...
func init() {
	...
	proto.RegisterType((*QueryRedeemEntryRequest)(nil), "gaia.usc.v1beta1.QueryRedeemEntryRequest")
	proto.RegisterType((*QueryRedeemEntryResponse)(nil), "gaia.usc.v1beta1.QueryRedeemEntryResponse")
}
...
func (c *queryClient) RedeemEntry(ctx context.Context, in *QueryRedeemEntryRequest, opts ...grpc.CallOption) (*QueryRedeemEntryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gaia.usc.v1beta1.Query/RedeemEntry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_RedeemEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gaia.usc.v1beta1.Query/RedeemEntry",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
